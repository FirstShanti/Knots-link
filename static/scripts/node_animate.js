(function() {
  ...
  Node.prototype.drawNode = function() {
    var color = "rgba(" + FIRST_COLOR + " " + this.brightness + ")";
    ctx.beginPath();
    ctx.arc(this.x, this.y, 4 * this.radius + 4 * this.siblings.length / SIBLINGS_LIMIT, 0, circ);
    ctx.fillStyle = color;
    ctx.fill();
  };
  ...
  Node.prototype.drawConnections = function() {
    for (var i = 0; i < this.siblings.length; i++) {
      var color = "rgba(" + SECOND_COLOR + " " + this.brightness + ")";
      ctx.beginPath();
